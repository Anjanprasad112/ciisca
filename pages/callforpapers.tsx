    ...
    <>
      <div className="w-full">
        ...
        <div className="w-1/2 p-auto m-auto ">
          <div className="text-2xl md:text-4xl font-semibold tracking-wide text-center m-2">Submission Guidelines</div>
...
evaluated for this Conference. The full manuscript must be submitted in IEEE format as Latex/Microsoft word. Paper length should be maximum of 6 pages. Papers submitted in the conference will
undergo a rigorous and peer review process. All presented papers
will be submitted to IEEE Xplore digital library and submitted for
indexing to Scopus.
          </div>
          <div className="text-center m-4">
            <div className="font-bold text-2xl">Regards</div>
            <div className="font-bold text-2xl" >Organising Team-CIISCA-2023</div>
          </div>
        </div>
        <Footer />
      </div>
